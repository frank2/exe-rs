//! This module only exports a single function. It's used to contain metadata used to perform
//! the imphash algorithm.
...
/// imphash ordinals for oleaut32.dll.
const OLEAUT32_ORDINALS: &[(u32, &'static str)] = &[
    (2u32, "SysAllocString"),
    (3, "SysReAllocString"),
    (4, "SysAllocStringLen"),
...
/// Resolve the given ordinal and DLL name according to the imphash algorithm.
pub fn imphash_resolve<S: AsRef<str>>(dll_name: S, ordinal: u32) -> String {
